      ...
      <SafeAreaProvider>
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
          ...
          {!detail ? (
            ...
            <SwipeDownScrollView style={styles.scroll} onClose={viewerOpen ? () => {} : closeAfterSavingFields} contentContainerStyle={styles.content} keyboardDismissMode="on-drag" keyboardShouldPersistTaps="handled">
