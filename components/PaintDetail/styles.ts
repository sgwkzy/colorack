...
export const makeStyles = (colors: typeof lightColors) => StyleSheet.create({
  ...
  primaryButton: { backgroundColor: colors.primaryAction, borderColor: colors.primary },
  ...
  saveBtn: { minHeight: touch.min, borderRadius: radius.md, backgroundColor: colors.primaryAction, paddingHorizontal: spacing.xl, paddingVertical: spacing.lg, alignItems: 'center', justifyContent: 'center' },
